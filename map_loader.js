require([
    ...
    */
    ...
    const view = new MapView({
      container: "viewDiv",
      map: map,
      center: [46.286224,-18.897805], // Center the map (long, lat) 46.286224,-18.897805
      zoom: 18
    });
      ...
      let buttonContainer = document.getElementById("parcs_but");
        ...
        geojson.features.forEach(feature => {
          const graphic = new Graphic({
            ...
            button.innerText = feature.properties.uuid; // Change this field based on GeoJSON
  ...
  load_points_parcels();
    ...
    async function load_test() {
        let l = await fetcher_2(tableName = "view_one_parcels", query = "*", filter_col="owner_uuid", filter_value="client_1_");
        //console.log(l);
    ...
    */
    ...
    async function loader() {
      ...
      let res = await fetc_4(tableName = "view_one_parcels", query = "*", filter_col="owner_uuid", filter_value="client_1_");
